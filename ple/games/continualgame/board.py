...
class Board(object):
    ...
    def __init__(self, width, height, rewards, _dir, map_dict):
        self.__width = width
    ...
    def populateMap(self):
        j = randint(0,19)
        map_key = "map"+str(j)
        self.map = copy.deepcopy(self._map_dict[map_key])#np.loadtxt(s, dtype='i', delimiter=',') #load new map everytime        
