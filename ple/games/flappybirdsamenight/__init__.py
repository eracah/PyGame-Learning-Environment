...
class Pipe(pygame.sprite.Sprite):
    ...
    def __init__(self,
        ...
        self.width = self.image_assets[color]["lower"].get_width()
        pygame.sprite.Sprite.__init__(self)
...
class FlappyBirdSameNight(base.PyGameWrapper):
    """
    ...
    def init(self):
        ...
        color = "night"#self.rng.choice(["day", "night"])
        self.backdrop.background_image = self.images["background"][color]

        # instead of recreating
        color = "yellow"#self.rng.choice(["red", "blue", "yellow"])
        self.player.init(self.init_pos, color)

        self.pipe_color = "red"#self.rng.choice(["red", "green"])
